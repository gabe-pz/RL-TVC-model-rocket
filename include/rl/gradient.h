...
std::array<std::array<float, 64*4>, 2> gradientLogPoliciesW1(const std::array<double, 4>& stateVec, std::array<float, 64>& y1, const std::array<float, 4>& yOut, const std::array<float, 4>& mK, 
    const std::array<std::array<float, 4>, 64>& partialsN);
//part 2 of gradients 
...
//part 3 of gradients 
std::array<std::array<float, 64*64>, 2> gradientLogPoliciesW2(const std::array<std::array<float, 64>, 4>& w3, const std::array<float, 64>& a1, const std::array<float, 64>& y2, const std::array<float, 4>& yOut, 
