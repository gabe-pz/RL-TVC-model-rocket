...
//part 3 of gradients 
std::array<std::array<float, 64*64>, 2> gradientLogPoliciesW2(const std::array<std::array<float, 64>, 64>& w2, const std::array<float, 64> a1, const std::array<float, 64> y2, const std::array<float, 4> yOut);